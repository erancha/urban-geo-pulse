...
@REM  ------------------------------------------------------
@REM  #1: SIMULATOR_THROTTLE_THROUGHPUT_PRODUCING=1250 
...
@REM  #2: SIMULATOR_THROTTLE_THROUGHPUT_PRODUCING=500 + all services: (elapsed === aggregator)
...
@REM    (c) Same as #2(a) with SIMULATOR_THROTTLE_THROUGHPUT_PRODUCING=750   ==> Very high lag   (~60,000 records), elapsed: ~4.55 minutes (several tests).

@REM    (d) Same as #2(a) with SIMULATOR_THROTTLE_THROUGHPUT_PRODUCING=1000  ==> Huge lag        (~90,000 records), elapsed: 6:25,6:05 minutes.
