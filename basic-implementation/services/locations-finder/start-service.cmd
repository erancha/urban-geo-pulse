	...
	@REM Note: LOCATIONS_FINDER_MOBILITY_TYPE_PARTITIONS_COUNT partitions (e.g. 15) = 
	@REM 		LOCATIONS_FINDER_CONSUMER_THREADS_COUNT of street 		 (e.g. 8) + 
	@REM 		LOCATIONS_FINDER_CONSUMER_THREADS_COUNT of neighborhood  (e.g. 7)
	@REM ----------------------------------------------------------------------------- 
	
    set LOCATIONS_FINDER_MOBILITY_TYPE=pedestrians
	set LOCATIONS_FINDER_MOBILITY_TYPE_PARTITIONS_COUNT=15

    set LOCATIONS_FINDER_LOCATION_TYPE=street
	set LOCATIONS_FINDER_CONSUMER_THREADS_COUNT=8
	for /l %%i in (1,1,1) do start /B  %EXECUTION_COMMAND%
	
    set LOCATIONS_FINDER_LOCATION_TYPE=neighborhood
	set LOCATIONS_FINDER_CONSUMER_THREADS_COUNT=7
    for /l %%i in (1,1,1) do start /B  %EXECUTION_COMMAND%

	@REM Note: LOCATIONS_FINDER_MOBILITY_TYPE_PARTITIONS_COUNT partitions = 
	@REM 		LOCATIONS_FINDER_CONSUMER_THREADS_COUNT of street + 
	@REM 		LOCATIONS_FINDER_CONSUMER_THREADS_COUNT of neighborhood 
	@REM -------------------------------------------------------------------
    ...
    set LOCATIONS_FINDER_LOCATION_TYPE=street
	set LOCATIONS_FINDER_CONSUMER_THREADS_COUNT=6
 	for /l %%i in (1,1,1) do start /B  %EXECUTION_COMMAND%

    set LOCATIONS_FINDER_LOCATION_TYPE=neighborhood
	set LOCATIONS_FINDER_CONSUMER_THREADS_COUNT=4
	for /l %%i in (1,1,1) do start /B  %EXECUTION_COMMAND%
